  ...
  return (
    <div className="space-y-6">
      <div className="card card-padding flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="page-subtitle">Ringkasan kelas, jadwal, dan aktivitas akademik sekolah.</p>
          </div>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {[
          { title: "Jadwal Pelajaran", desc: "Pengelolaan jadwal mengajar per kelas dan guru.", value: "12 kelas aktif" },
          { title: "Kalender Akademik", desc: "Agenda ujian, libur, dan event penting sekolah.", value: "Semester 2" },
          { title: "Rekap Kinerja", desc: "Pantau progres pembelajaran dan kehadiran.", value: "82% rata-rata" },
        ].map((item) => (
